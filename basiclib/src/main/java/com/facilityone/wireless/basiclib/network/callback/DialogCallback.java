...
public abstract class DialogCallback<T> extends JsonCallback<T> {
    ...
    public DialogCallback(AppCompatActivity activity) {
        this(activity, null);
    }

    public DialogCallback(AppCompatActivity activity, String tip) {
        super();
        initDialog(activity, tip);
    }

    private void initDialog(AppCompatActivity activity, String tip) {
